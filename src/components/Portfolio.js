    ...
    <div className="portfolio-contentContainer" id="projects">
      <div>
        ...
        <p className="section-subtitle">
          ...
          a web developer. I've provided the links to each application as well
          as their corresponding GitHub repositories. Several of the projects
          are not public-facing, however the company's websites have been
          attached for reference. Please feel free to explore both the
